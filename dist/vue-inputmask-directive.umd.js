(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['vue-inputmask-directive'] = factory();
  else root['vue-inputmask-directive'] = factory();
  ...
  return /******/ (function (modules) {
    ...
    /************************************************************************/
    /******/ {
      /***/ '23d1': /***/ function (module, exports, __webpack_require__) {
              ...
              function (module, exports, __webpack_require__) {
                ...
                (Inputmask.prototype = {
                  ...
                  setValue: function setValue(value) {
                    this.el &&
                      (0, _inputmask.default)(this.el).trigger('setvalue', [
                        value,
                      ]);
                  },
                    ...
                    'string' == typeof elems &&
                      ...
                      elems.forEach(function (el) {
                        el.inputmask
                          ...
                          : (0, _inputmask.default)(el).trigger('setvalue', [
                              value,
                            ]);
                      });
                  }),
                      ...
                      (lvTestAlt &&
                        ((lvTestAlt !==
                          ...
                          (!0 === testPos.match.static &&
                            ...
                            '' !==
                              _validationTests.getTests.call(this, pos)[0]
                                .def)))) &&
                      buffer[pos] ===
                    ...
                    switch (opts.positionCaretOnClick) {
                      ...
                      default:
                        ...
                        if (clickPosition <= lastPosition)
                          ...
                          if (
                            ('' !== placeholder &&
                              getBuffer.call(inputmask)[lastPosition] !==
                                placeholder &&
                  ...
                  function resolveTestFromToken(
                    ...
                    function handleMatch(match, loopNdx, quantifierRecurse) {
                      function isFirstMatch(latestMatch, tokenGroup) {
                        var firstMatch =
                          0 === tokenGroup.matches.indexOf(latestMatch);
                        return (
                          firstMatch ||
                      ...
                      function setMergeLocators(targetMatch, altMatch) {
                        ...
                        if (
                          ...
                          for (
                            ...
                            if (
                              targetMatch.locator[i] !== altMatch.locator[i]
                            ) {
                      ...
                      function isSameLevel(targetMatch, altMatch) {
                        if (
                          targetMatch.locator.length !== altMatch.locator.length
                        )
                          return !1;
                        for (
                      ...
                      if (void 0 !== match.matches) {
                        if (match.isGroup && quantifierRecurse !== match) {
                                ...
                                for (
                                  ...
                                  if (
                                    ...
                                    if (
                                      ...
                                      void 0 !==
                                        el.inputmask.userOptions.keepStatic
                                        ? setMergeLocators(
                                            altMatch,
                                            altMatch2,
                                          ) &&
                          ...
                          for (
                            ...
                            var tokenGroup =
                              maskToken.matches[
                                maskToken.matches.indexOf(qt) - 1
                              ];
                            if (
                              ((match = handleMatch(
                                tokenGroup,
              ...
              function (module, exports, __webpack_require__) {
                ...
                function alternate(
                  ...
                  if (
                    ...
                    for (; 0 <= lAltPos; lAltPos--)
                      if (
                        ...
                        (lastAlt = lAltPos),
                          (alternation =
                            maskset.validPositions[lastAlt].alternation),
                          (prevAltPos = altPos);
                      }
                  if (void 0 !== alternation) {
                    ...
                    for (
                      i = decisionPos;
                      i <
                      _positioning.getLastValidPosition.call(this, void 0, !0) +
                        1;
                      i++
                    )
                      -1 === resultPos &&
                ...
                function revalidateMask(
                  ...
                  if (
                    ...
                    for (
                      ...
                      if (
                        ...
                        for (
                          ;
                          '' !==
                          _validationTests.getTest.call(this, posMatch).match
                            .def;
                    ...
                    validTest &&
                      _validationTests.getTest.call(this, validatedPos).match
                        .cd === validTest.match.cd &&
                      (maskset.validPositions[validatedPos] = $.extend(
                        !0,
                        {},
                        validTest,
                  ...
                  function isTemplateMatch(ndx, charCodes) {
                    for (
                      var targetTemplate = _validationTests.getMaskTemplate
                          ...
                          .slice(
                            ndx,
                            _positioning.seekNext.call(inputmask, ndx),
                          )
                          .join('')
                          .replace(/'/g, ''),
                    ...
                    var match =
                      ...
                      (_validationTests.getTest.call(inputmask, ndx).match
                        ...
                        (' ' ===
                          _validationTests.getTest.call(inputmask, ndx).match
                            .nativeDef &&
                          (_validationTests.getTest.call(inputmask, ndx + 1)
                          ...
                          isTemplateMatch(initialNdx, charCodes)
                            ...
                            result
                              ? (void 0 !== result.pos &&
                                  ...
                                  !0 ===
                                    maskset.validPositions[result.pos].match
                                      .static &&
                                  void 0 ===
                                    maskset.validPositions[result.pos]
                                      .alternation &&
                    ...
                    (input.inputmask.skipInputEvent = !0),
                      ...
                      setTimeout(function () {
                        ...
                        _positioning.getBufferTemplate.call(inputmask).join('')
                          ...
                          : !0 ===
                              _validation.isComplete.call(inputmask, buffer) &&
                    ...
                    (inputmask.originalPlaceholder = el.placeholder),
                      ...
                      !0 === isSupported &&
                        ((opts.showMaskOnFocus =
                          opts.showMaskOnFocus &&
                          -1 ===
                            ['cc-number', 'cc-exp'].indexOf(el.autocomplete)),
                        ...
                        return (
                          ...
                          !1 !== isNegative
                            ? {
                                remove: isNegative,
                                caret:
                                  initPos - opts.negationSymbol.front.length,
                              }
                            : {
                                insert: [
                                  {
                                ...
                                caret:
                                  initPos + opts.negationSymbol.back.length,
                              }
                        );
                      }
                      ...
                      function stripBuffer(buffer, stripRadix) {
                        ...
                        if ('' !== opts.groupSeparator)
                          for (
                            ;
                            -1 !==
                            (position = buffer.indexOf(opts.groupSeparator));
                      ...
                      if (leadingzeroes)
                        for (
                          var caretNdx =
                            ...
                            offset =
                              leadingzeroes[0] == leadingzeroes.input ? 1 : 0,
      ...
      /***/ fae3: /***/ function (
        ...
        // CONCATENATED MODULE: ./src/mask.directive.ts
        ...
        inputmask_default.a.extendAliases({
          '2fa-code': twoFA,
        });
        /**
         * Directive
        ...
        var mask = {
          bind: function (element, binding) {
            ...
            if (input) {
              new inputmask_default.a(binding.value).mask(input);
            } else {
...
//# sourceMappingURL=vue-inputmask-directive.umd.js.map
